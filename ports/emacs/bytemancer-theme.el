...
(let (
      ...
      (purple "#A485DD")
      (red_bright "#FF90A1")
      (yellow_bright "#F2BF78")
      (green_bright "#AEDF7B")
      (blue_bright "#8FB3FF")
      (cyan_bright "#56C1B6")
      (purple_bright "#BD9EF8")
      (red_bg "#59001E")
      (red_bg2 "#190004")
      (yellow_bg "#523500")
      (yellow_bg2 "#201200")
  ...
  (custom-theme-set-faces
   ...
   `(ansi-color-black ((t (:foreground ,base))))
   ...
   `(ansi-color-bright-black ((t (:foreground ,fg_muted))))
   `(ansi-color-bright-red ((t (:foreground ,red_bright))))
   `(ansi-color-bright-green ((t (:foreground ,green_bright))))
   `(ansi-color-bright-yellow ((t (:foreground ,yellow_bright))))
   `(ansi-color-bright-blue ((t (:foreground ,blue_bright))))
   `(ansi-color-bright-magenta ((t (:foreground ,purple_bright))))
   `(ansi-color-bright-cyan ((t (:foreground ,cyan_bright))))
   `(ansi-color-bright-white ((t (:foreground ,fg_bright))))
