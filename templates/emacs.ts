...
${letBindings}
  ...
  (custom-theme-set-faces
   ...
   ;; ANSI colors (Ghostel inherits these faces)
   \`(ansi-color-black ((t (:foreground ,${n("ansi.black")}))))
   \`(ansi-color-red ((t (:foreground ,${n("ansi.red")}))))
   \`(ansi-color-green ((t (:foreground ,${n("ansi.green")}))))
   \`(ansi-color-yellow ((t (:foreground ,${n("ansi.yellow")}))))
   \`(ansi-color-blue ((t (:foreground ,${n("ansi.blue")}))))
   \`(ansi-color-magenta ((t (:foreground ,${n("ansi.magenta")}))))
   \`(ansi-color-cyan ((t (:foreground ,${n("ansi.cyan")}))))
   \`(ansi-color-white ((t (:foreground ,${n("ansi.white")}))))
   \`(ansi-color-bright-black ((t (:foreground ,${n("ansi.bright.black")}))))
   \`(ansi-color-bright-red ((t (:foreground ,${n("ansi.bright.red")}))))
   \`(ansi-color-bright-green ((t (:foreground ,${n("ansi.bright.green")}))))
   \`(ansi-color-bright-yellow ((t (:foreground ,${n("ansi.bright.yellow")}))))
   \`(ansi-color-bright-blue ((t (:foreground ,${n("ansi.bright.blue")}))))
   \`(ansi-color-bright-magenta ((t (:foreground ,${n("ansi.bright.magenta")}))))
   \`(ansi-color-bright-cyan ((t (:foreground ,${n("ansi.bright.cyan")}))))
   \`(ansi-color-bright-white ((t (:foreground ,${n("ansi.bright.white")}))))
